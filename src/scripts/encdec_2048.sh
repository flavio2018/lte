...
python train_encdec.py codename=encdec_eos_sum_sub max_len=1 max_nes=2 hid_size=2048
python train_encdec.py codename=encdec_eos_sum_sub max_len=1 max_nes=3 hid_size=2048
